            ...
            <div class="mb-3">
                <form class="form-dashboard">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="userName" value="<?php echo $response['usuario']['nome']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="userSurname" class="form-label">Sobrenome</label>
                        <input type="text" class="form-control" id="userSurname" value="<?php echo $response['usuario']['sobrenome']; ?>" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="userAccessLevel">
                            <?php foreach ($access_level['nivel_acesso'] as $access) : ?>
                                <option value="<?php echo $access['id']; ?>" <?php echo $access['id'] === $response['usuario']['id_nivel_acesso'] ? 'selected' : ''; ?> ><?php echo $access['nome']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="userBio" class="form-label"><?php echo $response['usuario']['biografia']; ?></label>
                        <textarea class="form-control" id="userBio" rows="8"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="userBirthday" class="form-label">Data de nascimento</label>
                        <input type="date" class="form-control" id="userBirthday" value="<?php echo $response['usuario']['data_nascimento']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="userEmail" class="form-label">Email</label>
                        <input type="email" class="form-control" id="userEmail" value="<?php echo $response['usuario']['email']; ?>" required>
                    </div>
