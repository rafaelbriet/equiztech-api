...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    <main class="form-password-reset w-100 m-auto">
        ...
        <p>Senha atualizada com sucesso! Agora basta voltar a tela de login e utilizar a nova senha para entrar.</p>
        <p class="mt-2 text-center">
            <a href="<?php echo $_ENV['BASE_URL']; ?>" class="btn btn-primary w-100 py-2">Login</a>
        </p>
    </main>
